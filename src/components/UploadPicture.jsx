...
class CUploadPicture extends Component {
  state = { iconColor: "lightGrey", showProgressBar: false, showProgressMessage: false };
  ...
  render() {
    ...
    const handleUpload = (e) => {
      // let fileName = this.fileElement.files.item(0).name;
      // let fileSize = this.fileElement.files.item(0).size / 1000000;

      this.setState({ showProgressBar: true, showProgressMessage: true })
    }
    ...
    return (
      <Card style={uploadPictureBoxStyle}>
        ...
        <Card.Body>
          ...
          <Button variant="primary" onClick={() => { this.fileElement.click() }}>Upload Picture</Button>
